...
# 1- Perguntar ao usuário C alugado.
...
carro = input("qual foi o modelo do carro: ")
...
valor_dias = dias * 0.25
valor_km = km *  0.15
valor_total = valor_dias + valor_km



print(f"vc percorreu {km}km por {dias} dias, entao o preçio a pagar é R${valor_total}")